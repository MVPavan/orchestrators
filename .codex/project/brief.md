...
- **Agent runtimes:** Codex CLI/app harness, Claude Code legacy harness, Gemini CLI as a likely peer runtime.
...
- The reusable Codex-facing harness lives under `.codex/`; `.codex/project/` is the repo-specific overlay.
- The legacy Claude Code harness remains under `.claude/` for Claude-specific runs.
...
- The Codex integration research is captured in `docs/research/codex-usage-options.md`.
- Codex-native skills, agents, hooks, rules, and project overlay now live under `.codex/`; standalone CLI wrapper scripts are not implemented yet.
